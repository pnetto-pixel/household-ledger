...
Versão atual: **v1.74.0** (branch `claude/feature-workflow-badges-status-c4audy`) —
...
`claude/feature-workflow-badges-status-c4audy`, já mergeada em `main` —
"draft" da nota original ficou desatualizado) —
