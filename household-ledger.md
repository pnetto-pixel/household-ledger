...
Versão atual: **v1.5.17** (bugfix card "by category": categorias com refunds superiores às despesas (total >= 0) eram exibidas incorretamente; filtro trocado para `v < 0`; display trocado para `-total`; M/M e Y/Y agora tratam base >= 0 como sem comparável para evitar sinal invertido.)
